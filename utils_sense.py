...
#    print (item_features_list[-1])
    ...
    for i in range(len(given_preference)): # given_preference list: asked cluster list, type list, category list
        if i == 0:
...
#    print (asked_cluster_embedding.size())
#    print (asked_poi_type_embedding.size())
...
#    print (history_item_features_list) 
...
#        print (time, category, cluster, poi_type)
